...
SOpener@ GetOpenInfo()
{
	return SOpener({
		{Factory::armlab, array<SQueue> = {
			...
			SQueue(0.3f, {SO(RT::BUILDER), SO(RT::SCOUT, 15), SO(RT::RAIDER, 15), SO(RT::BUILDER)})
			// scout start
		...
		{Factory::armalab, array<SQueue> = {
			SQueue(1.0f, {SO(RT::BUILDER2), SO(RT::HEAVY, 3), SO(RT::ASSAULT, 6), SO(RT::SKIRM, 3), SO(RT::BUILDER2), SO(RT::AHA, 5), SO(RT::BUILDER2)})
		}},
